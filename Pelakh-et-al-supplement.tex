...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomtitle=1mm, breakable, colframe=quarto-callout-note-color-frame, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, left=2mm, opacitybacktitle=0.6, toptitle=1mm, colback=white, titlerule=0mm, arc=.35mm, toprule=.15mm, rightrule=.15mm, leftrule=.75mm, bottomrule=.15mm]
