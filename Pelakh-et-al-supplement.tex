...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, opacityback=0, colbacktitle=quarto-callout-note-color!10!white, breakable, colback=white, bottomtitle=1mm, bottomrule=.15mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame, titlerule=0mm, arc=.35mm, left=2mm, toptitle=1mm, toprule=.15mm, leftrule=.75mm, opacitybacktitle=0.6, coltitle=black]
